...
namespace TaxBill.Kimlik {
    ...
    public interface KPSPublicSoap {
        ...
        TaxBill.Kimlik.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(TaxBill.Kimlik.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<TaxBill.Kimlik.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(TaxBill.Kimlik.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public TaxBill.Kimlik.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(TaxBill.Kimlik.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public TaxBill.Kimlik.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(TaxBill.Kimlik.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : TaxBill.Kimlik.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<TaxBill.Kimlik.KPSPublicSoap>, TaxBill.Kimlik.KPSPublicSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TaxBill.Kimlik.TCKimlikNoDogrulaResponse TaxBill.Kimlik.KPSPublicSoap.TCKimlikNoDogrula(TaxBill.Kimlik.TCKimlikNoDogrulaRequest request) {
        ...
        public bool TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            TaxBill.Kimlik.TCKimlikNoDogrulaRequest inValue = new TaxBill.Kimlik.TCKimlikNoDogrulaRequest();
            inValue.Body = new TaxBill.Kimlik.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            TaxBill.Kimlik.TCKimlikNoDogrulaResponse retVal = ((TaxBill.Kimlik.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<TaxBill.Kimlik.TCKimlikNoDogrulaResponse> TaxBill.Kimlik.KPSPublicSoap.TCKimlikNoDogrulaAsync(TaxBill.Kimlik.TCKimlikNoDogrulaRequest request) {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<TaxBill.Kimlik.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            TaxBill.Kimlik.TCKimlikNoDogrulaRequest inValue = new TaxBill.Kimlik.TCKimlikNoDogrulaRequest();
            inValue.Body = new TaxBill.Kimlik.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((TaxBill.Kimlik.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
    }
}
